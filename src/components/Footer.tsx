    ...
    <footer id="contact" className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8">
          {/* About */}
          <div>
            <h3 className="text-white text-xl font-bold mb-4">Egypt Tours</h3>
            <p className="text-gray-400 leading-relaxed">
              Your trusted local guide to Egypt's ancient wonders and modern
              treasures. Experience authentic Egypt with personalized tours.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400">
            &copy; {currentYear} Egypt Tours. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
