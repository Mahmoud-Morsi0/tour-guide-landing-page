    ...
    <footer id="contact" className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8">
          ...
          <div>
            <h3 className="text-white text-xl font-bold mb-4">{t('quickLinks')}</h3>
            <ul className="space-y-2">
              ...
              <li>
                <a href="#tours" className="hover:text-amber-400 transition-colors">
                  {t('tours')}
                </a>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-white text-xl font-bold mb-4">{t('contactUs')}</h3>
            <ul className="space-y-3">
              ...
              <li className="text-gray-400">
                <span className="font-medium text-gray-300">{t('phone')}:</span>{' '}
                <a href={`tel:${whatsappNumber}`} className="hover:text-amber-400 transition-colors">
                  {whatsappNumber}
                </a>
              </li>
              <li className="text-gray-400">
                <span className="font-medium text-gray-300">{t('location')}:</span> {t('egypt')}
              </li>
            </ul>
          </div>
        </div>
