      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center text-white pt-20">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            Explore Egypt with a{' '}
            <span className="text-amber-400">Local Expert</span>
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl mb-8 text-gray-100 max-w-2xl mx-auto leading-relaxed">
            Discover the wonders of ancient Egypt through authentic experiences.
            From the majestic Pyramids to the tranquil Nile, let us guide you
            through history, culture, and breathtaking landscapes.
          </p>
          <a
            href={whatsappUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-[#25D366] text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-[#20BA5A] transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            <svg
              className="w-6 h-6"
              fill="currentColor"
